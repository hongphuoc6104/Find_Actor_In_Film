...
if __name__ == "__main__":
    # Đảm bảo bạn đang ở thư mục gốc của dự án khi chạy file này
    # để các import có thể hoạt động chính xác.
    try:
        main()
    except FileNotFoundError as e:
        print(f"\n[LỖI] Không tìm thấy file dữ liệu cần thiết: {e}", file=sys.stderr)
        print("Vui lòng đảm bảo bạn đã chạy pipeline thành công và các file trong 'warehouse/' đã được tạo.", file=sys.stderr)
